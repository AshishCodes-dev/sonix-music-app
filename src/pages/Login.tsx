  ...
  const emailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignup) {
        ...
        // Give the auth state a beat to propagate, then navigate.
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md glass-strong rounded-3xl p-8 relative overflow-hidden z-10">
        ...
        <div className="relative">
          ...
          <button onClick={() => signInWithGoogle('SONIQ')} className="w-full glass py-3 rounded-xl font-medium flex items-center justify-center gap-3 hover:glow-cyan transition">
